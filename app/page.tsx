  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      <section className="mx-auto flex max-w-6xl flex-col items-center px-6 py-32 text-center">
        ...
        <Link
          href="/articles"
          className="mt-12 rounded-full bg-black px-8 py-4 text-white transition hover:bg-zinc-800"
        >
          Explore Articles
        </Link>
      </section>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-6 pb-32 md:grid-cols-3">
        <div className="rounded-2xl border border-zinc-200 p-8">
          <h2 className="mb-4 text-2xl font-semibold">Practical Guidance</h2>
        ...
        <div className="rounded-2xl border border-zinc-200 p-8">
          <h2 className="mb-4 text-2xl font-semibold">Thoughtful Research</h2>
          <p className="leading-8 text-zinc-600">
        ...
        <div className="rounded-2xl border border-zinc-200 p-8">
          <h2 className="mb-4 text-2xl font-semibold">Useful Tools</h2>
          <p className="leading-8 text-zinc-600">
